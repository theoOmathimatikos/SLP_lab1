...
def make_input_fst(word):
    ...
    for i, c in enumerate(word):
        # You need to implement format_arc function in scripts/util
        print(format_arc(s, s + 1, c, c, weight=0)) # accept letter by letter: δέχεται c επιστρέφει c με βάρος 0.
        s += 1
